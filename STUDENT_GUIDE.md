...
이 문서는 저장소를 처음 받은 시점부터 Agent 실행, Red Team 분석, Blue Team 방어, GitHub 및 최종 보고서 제출까지의 전체 절차를 설명한다.
...
세부 제출 요건과 배점은 [ASSIGNMENT.md](ASSIGNMENT.md), PDF 구성은 [REPORT_GUIDE.md](REPORT_GUIDE.md)를 확인한다.
